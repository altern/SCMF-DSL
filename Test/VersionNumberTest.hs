...
{-    "test B01"  ~: "decrement VC 0"        ~: "0"      ~=? ( versionCompoundToString ( decrement (Just 0 ) ) ),-}
    ...
    "test G01"  ~: "decrementDim 0 VN 5"     ~: "5"      ~=? ( versionNumberToString ( decrementDimension 0 $ VersionNumber [Just 5] ) ),
    "test G02"  ~: "decrementDim 1 VN 5"     ~: "4"      ~=? ( versionNumberToString ( decrementDimension 1 $ VersionNumber [Just 5] ) ),
    "test G03"  ~: "decrementDim 0 VN x.x"   ~: "x.x"    ~=? ( versionNumberToString ( decrementDimension 0 $ VersionNumber [Nothing, Nothing] ) ),
    "test G04"  ~: "decrementDim 1 VN x.x"   ~: "x.x"    ~=? ( versionNumberToString ( decrementDimension 1 $ VersionNumber [Nothing, Nothing] ) ),
    "test G05"  ~: "decrementDim 2 VN x.x"   ~: "x.x"    ~=? ( versionNumberToString ( decrementDimension 2 $ VersionNumber [Nothing, Nothing] ) ),
    "test G06"  ~: "decrementDim 3 VN x.x"   ~: "x.x"    ~=? ( versionNumberToString ( decrementDimension 3 $ VersionNumber [Nothing, Nothing] ) ),
    "test G07"  ~: "decrementDim 0 VN 3.x"   ~: "3.x"    ~=? ( versionNumberToString ( decrementDimension 0 $ VersionNumber [Just 3, Nothing] ) ),
    "test G08"  ~: "decrementDim 1 VN 3.1"   ~: "3.0"    ~=? ( versionNumberToString ( decrementDimension 1 $ VersionNumber [Just 3, Just 1] ) ),
    "test G09"  ~: "decrementDim 2 VN x.5"   ~: "x.5"    ~=? ( versionNumberToString ( decrementDimension 2 $ VersionNumber [Nothing, Just 5] ) ),
    "test G10"  ~: "decrementDim 3 VN x.6"   ~: "x.6"    ~=? ( versionNumberToString ( decrementDimension 3 $ VersionNumber [Nothing, Just 6] ) ),
    {-"test G10"  ~: "decrementDim x VN x.6"   ~: "x.6"    ~=? ( versionNumberToString ( decrementDimension Nothing (VN (VC Nothing) (Just 6)) ) ),-}
    "test G11"  ~: "decrementDim 3 VN x.x.6" ~: "x.x.6"  ~=? ( versionNumberToString ( decrementDimension 3 $ VersionNumber [Nothing, Nothing, Just 6] ) ),
    "test H01"  ~: "incrementDim 0 VN x.1"   ~: "x.1"    ~=? ( versionNumberToString ( incrementDimension 0 $ VersionNumber [Nothing, Just 1] ) ),
    "test H02"  ~: "incrementDim 1 VN x.2"   ~: "x.3"    ~=? ( versionNumberToString ( incrementDimension 1 $ VersionNumber [Nothing, Just 2] ) ),
    "test H03"  ~: "incrementDim 1 VN 3.2"   ~: "3.3"    ~=? ( versionNumberToString ( incrementDimension 1 $ VersionNumber [Just 3, Just 2] ) ),
    "test H04"  ~: "incrementDim 2 VN 3.2"   ~: "4.2"    ~=? ( versionNumberToString ( incrementDimension 2 $ VersionNumber [Just 3, Just 2] ) ),
    "test H05"  ~: "incrementDim 3 VN 3.2"   ~: "3.2"    ~=? ( versionNumberToString ( incrementDimension 3 $ VersionNumber [Just 3, Just 2] ) ),
    {-"test H06"  ~: "incrementDim x VN 2.0"   ~: "2.0"    ~=? ( versionNumberToString ( incrementDimension Nothing (VN (VC (Just 2)) (Just 0)) ) ),-}
    "test H07"  ~: "incrementDim 3 VN x.x.1" ~: "x.x.1"  ~=? ( versionNumberToString ( incrementDimension 3 $ VersionNumber [Nothing, Nothing, Just 1] ) ),
    "test I02"  ~: "createVNByNumberOfDimensions 0"        ~: ""        ~=? ( versionNumberToString $ createVersionNumberByNumberOfDimensions 0 ),
    "test I03"  ~: "createVNByNumberOfDimensions 1"        ~: "x"        ~=? ( versionNumberToString $ createVersionNumberByNumberOfDimensions 1 ),
    "test I04"  ~: "createVNByNumberOfDimensions 2"        ~: "x.x"    ~=? ( versionNumberToString $ createVersionNumberByNumberOfDimensions 2 ),
    "test I05"  ~: "createVNByNumberOfDimensions 4"        ~: "x.x.x.x"~=? ( versionNumberToString $ createVersionNumberByNumberOfDimensions 4 ),
