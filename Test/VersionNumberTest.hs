...
versionNumberTests = test [ 
    ...
    "test E01"  ~: "decrement VN x"          ~: "x"      ~=? ( versionNumberToString ( decrement (VersionNumber [Nothing]) ) ),
    "test E02"  ~: "decrement VN 3"          ~: "3"      ~=? ( versionNumberToString ( decrement (VersionNumber [Just 4] ) ) ),
    "test E03"  ~: "decrement VN 1"          ~: "0"      ~=? ( versionNumberToString ( decrement (VersionNumber [Just 1] ) ) ),
    "test E04"  ~: "decrement VN 0"          ~: "0"      ~=? ( versionNumberToString ( decrement (VersionNumber [Just 0] ) ) ),
    "test F01"  ~: "increment VN x"          ~: "x"      ~=? ( versionNumberToString ( increment (VersionNumber [Nothing] ) ) ),
    "test F02"  ~: "increment VN 4"          ~: "5"      ~=? ( versionNumberToString ( increment (VersionNumber [Just 4] ) ) ),
    "test F03"  ~: "increment VN 35"         ~: "36"     ~=? ( versionNumberToString ( increment (VersionNumber [Just 35] ) ) ),
