...
tests = test [ 
    ...
    "test J03"  ~: "isInitalVersionNumber 1"			~: True     ~=? ( isInitialVersionNumber (VersionCompound (Number 1) ) ),
    "test J03a" ~: "isInitalVersionNumber 0"			~: True     ~=? ( isInitialVersionNumber (VersionCompound (Number 0) ) ),
    "test J03b" ~: "isInitalVersionNumber x.0"			~: True     ~=? ( isInitialVersionNumber $ stringToVersionNumber "x.0"),
