...
versionNumberTests = test [ 
    ...
    "test K01"  ~: "isZero x.0"                           ~: True     ~=? ( isZero $ stringToVersionNumber "x.0"),
    "test K02"  ~: "isZero x.x.0"                         ~: True     ~=? ( isZero $ stringToVersionNumber "x.x.0"),
    "test K03"  ~: "isZero 1"                             ~: False    ~=? ( isZero $ stringToVersionNumber "1"),
