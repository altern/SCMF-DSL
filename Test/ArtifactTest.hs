...
tests = test [ 
    ...
    "test C01"    ~: "artifactToString artifact1"                        ~: "Dev/10"                                                        ~=? artifactToString (Artifact ( Right (Snapshot 12372 ( MaturityVersion Dev $ VersionNumber [Just 10] ) ( DocumentOrDirectory (Left (Document "doc1" "content1" ) ) ) ) ) ), 
    "test C02"    ~: "artifactToString artifact2"                        ~: "branch3 (x)"                                                ~=? artifactToString (Artifact ( Left (Branch "branch3" ( Version $ VersionNumber [Nothing] ) ( DocumentOrDirectory (Left (Document "doc2" "content2" ) ) ) ) ) ), 
