...
SubVersion (SubVersion (SubVersion (VersionCompound (Number 1)) NumberPlaceholder ) NumberPlaceholder) (Number 0)   
	\end{lstlisting}
	%&
%	\begin{lstlisting}[style=Examples,caption=]
%	 X 
%	 1 
%	 45 
%	 X.X 
...
%\subsection{MaturityLevelBuild}
%
%\begin{lstlisting}[caption=BNF]
%MaturityLevelBuild ::= Dev | Test |  User		 
%\end{lstlisting}		
%
%\begin{lstlisting}
%
%data MaturityLevelBuild = Dev
%                        | Test
%                        | User
%                        deriving (Show)
%\end{lstlisting}
...
%\subsection{MaturityLevelRelease}
%	
%\begin{lstlisting}[caption=BNF]
%MaturityLevelRelease ::= Test | User | ReleaseCandidate | Stable
%\end{lstlisting}	
%
%\begin{lstlisting}
%
%data MaturityLevelRelease = Test
%                        | User
%                        | ReleaseCandidate
%                        | Stable
%                        deriving (Show)
...
data RepositoryType = SVN
                    ...
                    deriving (Show)
\end{lstlisting}
\subsubsection{RepositoryProperty}
\begin{lstlisting}
